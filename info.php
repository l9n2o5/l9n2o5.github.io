...
<hr>
<h2>Exercises</h2>
<div style="width: 100%; display: inline-block; vertical-align: top; margin-left: auto; margin-right: auto;">
  <div class="table-responsive-vertical shadow-z-1">
  <table id="table" class="center table table-hover table-mc-light-blue">
      <thead>
        <tr>           
          <th>Date</th>
          <th>Topic</th>
...
<hr>
    ...
    <!-- <?php if($_POST) { ?> <br> Thank you for your feedback!<?php } ?> -->
</section>
</body>
</html>
